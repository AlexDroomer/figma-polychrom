<div class="relative overflow-hidden">
	<svg
		class="text-elevation-1 active:text-universal-25 translate-y-0.5 hover:translate-y-0"
		fill="none"
		height="19"
		viewBox="0 0 88 38"
		width="44"
	...
	>
		...
		/>
		<path
			class="animate-lurkers-blink origin-center"
		...
		/>
		<path
			class="animate-lurkers-blink animation-delay-500 origin-center"
